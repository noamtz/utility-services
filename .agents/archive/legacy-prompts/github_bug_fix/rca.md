...
This RCA document should be used by `/piv-implement-bugfix` command.

## Next Steps

1. Review this RCA document
2. Run: `/piv-implement-bugfix $ARGUMENTS` to implement the fix
3. Run: `/piv-commit` after implementation complete
```
