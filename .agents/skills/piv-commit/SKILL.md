...
0. **Read this project's conventions.** If `.agents/references/conventions.md` exists, read its `## commit`
...
### AI Layer Changes
Only include this section if the AI layer changed (`AGENTS.md`, `.agents/`, `.codex/`, `.archon/workflows/`, or `tooling/mcp/`).

List each changed AI-layer file with a one-line note on what evolved and why. If the AI layer did not change, omit this section entirely.
