---
name: prime-tools
description: Load the repository's agent-tool design references before building or modifying Pydantic AI or MCP tools. Use when planning tool schemas, writing tool descriptions, or reviewing agent-facing tool ergonomics.
---
...
Read `.agents/references/adding_tools_guide.md` completely before designing or reviewing a tool.
