...
Code-review (file or description of issues): the review input from the user's request

Direction / scope (what to fix now vs defer): the scope from the user's request
