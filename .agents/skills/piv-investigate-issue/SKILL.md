...
Save analysis as: `docs/issues/issue-<issue-number>.md`
...
```bash
gh issue comment <issue-number> --body "<title · the Assessment table (severity/complexity/confidence + one-line reasons) · root cause in 1–2 lines · files to change · next: $piv-implement-issue <issue-number>>"
```
